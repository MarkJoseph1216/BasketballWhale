package com.example.basketballwhale.Library;
...
public class ModifiedViewPager extends ViewPager implements ViewPager.PageTransformer {
    public static final String TAG = "ModifiedViewPager";
